...
const FourthPage = ({ correctAnswer, nextPage }) => {
  ...
  return (
    <div style={{ textAlign: 'center', marginTop: '50px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' }}>
        <YouTubeAudioPlayer key={nextPage} videoId="2b-dSo3pZ_Y" />
        <input
          type="text"
          value={guess}
...
/**
 * 
 * <iframe width="560" height="315" src="https://www.youtube.com/embed/2b-dSo3pZ_Y?si=1LQDA6Ny6LRGgwYW" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
 */